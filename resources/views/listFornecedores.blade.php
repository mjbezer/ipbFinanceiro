        ...
        <div class="modal-dialog modal-md">
             <div class="modal-content animated fadeIn">
                 <div class="modal-header">
                       ...
                       <h4 class="modal-title">Exclusão de fornecedor Bancária</h4>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Lista Geral de Fornecedores</strong>
            </li>
        </ol>
    </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-striped table-hover">
                                                                    <thead>
                                                                        ...
                                                                        <th class="celcenter"><a href="/fornecedores/create" class="btn btn-outline btn-primary btn-sm"><i class="fa fa-plus-square-o"></i> Novo Fornecedor</a></th>
